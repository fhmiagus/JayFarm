...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      {/* Announcement bar */}
      <div className="w-full bg-green-700 text-white text-xs sm:text-sm py-2 px-4 text-center font-medium">
      ...
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 md:px-10 py-3 md:py-4 flex items-center justify-between">
          {/* Logo */}
          <a href="#" className="flex items-center gap-2">
            <img src={logo} alt="Jay Farm Logo" className="h-10 w-10 sm:h-12 sm:w-12 rounded-full object-cover" />
            <span className={`text-xl sm:text-2xl font-bold ${scrolled ? 'text-gray-800' : 'text-white'}`}>
