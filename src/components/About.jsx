      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <FadeUpWrapper delay={0.15}>
            ...
            <div className="flex flex-col gap-5 mb-10">
              {features.map((f) => (
                <div key={f.title} className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-green-100 rounded-sm flex items-center justify-center text-lg flex-shrink-0">
                    {f.icon}
                  </div>
                  <div>
                    <strong className="block text-gray-900 font-semibold mb-1">{f.title}</strong>
            ...
            <a
              href="#contact"
              className="inline-block px-8 py-3.5 rounded-md font-semibold text-white bg-gradient-to-br from-green-600 to-green-700 shadow-md hover:from-green-700 hover:to-green-800 hover:-translate-y-0.5 transition-all duration-300"
            >
              Kunjungi Farm Kami
            </a>
          </FadeUpWrapper>
